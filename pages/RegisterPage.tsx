    ...
    >
      ...
      <View style={styles.registerContainer2}>
        ...
        <View style={styles.RC2Top}>
          <Text style={styles.RC2Title}>Create Account</Text>
          <Text style={styles.RC2Subtitle}>Register and be a passenger</Text>
        </View>
        ...
        <View style={styles.RC2Mid}>
          ...
          <TouchableOpacity style={styles.RPButton} onPress={submitRegister}>
            <LinearGradient
              start={{ x: 1, y: 1 }}
              end={{ x: 0, y: 1 }}
              colors={["#005F4F", "#053143"]}
