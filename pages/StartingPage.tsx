...
const StartingPage = ({ onRegister, onDriver }) => {
  return (
    <LinearGradient
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 0 }}
    ...
    >
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.RPButton} onPress={onRegister}>
          <LinearGradient
            start={{ x: 1, y: 1 }}
            end={{ x: 0, y: 1 }}
            colors={["#005F4F", "#053143"]}
        ...
        <Text style={styles.DriverText} onPress={onDriver}>Are you a driver? Click here</Text>
      </View>
    </LinearGradient>
  );
}
