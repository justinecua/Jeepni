...
const StartingPage2 = ({onStartPage1, onRegDriver}) => {
  return (
    <LinearGradient
      start={{ x: 0, y: 0 }}
      end={{ x: 1, y: 0 }}
    ...
    >
      <View style={styles.container}>
        ...
        <TouchableOpacity style={styles.RPButton} onPress={onRegDriver}>
          <LinearGradient
            start={{ x: 1, y: 1 }}
            end={{ x: 0, y: 1 }}
            colors={["#005F4F", "#053143"]}
        ...
        <Text style={styles.DriverText} onPress={onStartPage1}>Are you a passenger? Click here</Text>
      </View>
    </LinearGradient>
  );
}
